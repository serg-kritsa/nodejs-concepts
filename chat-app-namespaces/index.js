const io = require('./src/server/socket');
...
io.on('connection',(socket)=>{
    ...
    socket.emit('sendNamespacesList',nsData);
})
...
namespaces.forEach((namespace) => {
    io.of(namespace.endpoint).on('connection',(nsSocket)=>{
        ...
        // a socket has connected to one of our chatgroup namespaces. send that ns gorup info back
        nsSocket.emit('sendNamespaceRoomsList', namespace.rooms)
        nsSocket.on('joinRoom',(roomToJoin,numberOfUsersCallback)=>{
            ...
            nsSocket.emit('sendRoomMessagesList', nsRoom.history)
